...
#define CUSTOM_MENDEL_NAME "DIY Tech i3a Mendel"
...
//    You must specify the X & Y coordinates of all 3 points
 ...
 //  #define Z_PROBE_OFFSET_FROM_EXTRUDER -7.52
 // If measuring and get Z <0 add this negative number to offset below -.1 
 // Using .1mm gauge, this should think it is at .2 
 // More negative to lower nozzle.
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -.56
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000*(1+0.0475),92.65} // GT2, 20 TOOTH PULLEY, Z-AXIS: M5 threaded rod .8mm PITCH
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 35,135} // X,Y,Z Axis Extend and Retract angles
